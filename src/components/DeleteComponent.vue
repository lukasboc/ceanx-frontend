<template>
  <div class="modal modal-open">
    <div class="modal-box">
      <h2 class="text-xl pb-8 text-center">Komponente löschen</h2>

      <p>Bist du sicher, dass du diese Komponente für Jira-Suchen löschen möchtest?</p>
        <div class="p-2"/>
...
export default {
  ...
  methods: {
    async deleteComponent(){
        this.$store.dispatch("components/deleteComponent", this.id).then(() => {
          this.$emit('refresh')
          this.$emit('close')
        }).catch(error => {
