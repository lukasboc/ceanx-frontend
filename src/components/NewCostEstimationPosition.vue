    ...
    <div class="modal-box w-screen lg:max-w-5xl max-h-screen overflow-visible overflow-x-auto">
      ...
      <div v-if="step === 2">
        ...
        <div class="form-control w-full">
          ...
          <textarea v-model="comment" id="comment" @keydown.tab="createPosition();" placeholder="Kommentar" class="textarea textarea-bordered textarea-primary w-full "></textarea>
        </div>
      </div>
        ...
        <div class="modal-action">
          <div class="mx-auto">
            <button v-if="step > 0" class="btn btn-primary btn-outline mx-2" type="button" @click="this.step--">Zurück</button>
            <button v-if="step < 2" class="btn btn-primary mx-2" type="button" @click="this.step++">Weiter</button>
            <button v-if="step === 2" class="btn btn-primary mx-2" @click="createPosition();" type="button">Speichern</button>
...
export default {
  name: "NewCostEstimationPosition",
  props: {
  ...
  methods: {
    async createPosition(){
      ...
      if(await this.v$.$validate()){
        this.$store.dispatch("costEstimationPositions/createCostEstimationPosition", {
